...
![图4-9](https://book.flutterchina.club/assets/img/4-9.86777353.png)
...
![图4-10示例|99](https://book.flutterchina.club/assets/img/4-10.c3de517d.png)
...
![图4-11](https://book.flutterchina.club/assets/img/4-11.cc8d50f6.png)
...
![图4-12](https://book.flutterchina.club/assets/img/4-12.00885ea7.png)
...
| 属性名                    | 适用组件         | 作用说明                         | 可选值/默认值                                                                                       |
| ---------------------- | ------------ | ---------------------------- | --------------------------------------------------------------------------------------------- |
| **children**           | Row / Column | 所有子组件的列表，是布局的核心必填参数          | 无默认值，需传入Widget数组                                                                              |
| **mainAxisAlignment**  | Row / Column | 控制子组件在主轴上的分布对齐               | 默认值`MainAxisAlignment.start`，<br>可选：start/end/center/spaceBetween<br>/spaceAround/spaceEvenly |
| **mainAxisSize**       | Row / Column | 控制主轴方向容器自身的尺寸策略              | 默认值`MainAxisSize.max`，可选：max/min                                                              |
| **crossAxisAlignment** | Row / Column | 控制子组件在交叉轴上的对齐                | 默认值`CrossAxisAlignment.center`，<br>可选：start/end/center/stretch/baseline                       |
| **textDirection**      | Row / Column | 定义水平方向的文本排列顺序，影响主轴对齐的起始位置    | 可选：TextDirection.ltr/rtl                                                                      |
| **verticalDirection**  | Column / Row | 定义垂直方向的排列顺序，影响主轴对齐的起始位置      | 默认值`VerticalDirection.down`，<br>可选：down/up                                                    |
| **textBaseline**       | Row / Column | 配合baseline对齐模式使用，指定文本对齐的基线类型 | 可选：TextBaseline.alphabetic/ideographic                                                        |
